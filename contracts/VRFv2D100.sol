...
contract VRFv2D100 is VRFConsumerBaseV2 {
  ...
  event RequestedRandomWords(uint256 indexed requestId, address indexed roller);
   ...
   * @dev NETWORK: RINKEBY
   *
   * @param _linkToken {address} - linkToken contract address uses for funding, check https://docs.chain.link/docs/vrf-contracts/#configurations
   ...
   */
  function getRandomWords(address _roller) public returns (uint256 requestId) {
