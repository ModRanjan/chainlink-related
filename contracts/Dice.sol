...
contract Dice {
  ...
  constructor() payable {
    ...
    console.log('from dice.sol :', address(this).balance);
  }
   ...
   */
  function rollDice(address _player) external returns (uint256 winningAmount) {
    ...
    returns (string memory _msg)
  {
    ...
    userBets[msg.sender].winingAmount =
      userBets[msg.sender].winingAmount -
      _withdrawlAmount;
